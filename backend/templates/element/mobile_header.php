...
<div v-if="showSearchResults && searchQuery.length > 0" 
    ...
    <div @click.stop 
         class="absolute inset-x-4 top-32 max-h-[70vh] bg-white rounded-xl shadow-2xl border border-blue-100 overflow-hidden">
        ...
        <div v-else class="overflow-y-auto max-h-[70vh]">
            ...
            <div v-if="searchResults.users.length > 0" class="border-b border-blue-100">
                <div class="px-4 py-2 bg-blue-50 sticky top-0">
                    <h4 class="text-xs font-bold text-blue-700 uppercase">People</h4>
                </div>
                <a v-for="user in searchResults.users" 
                   :key="user.id"
                   :href="'/profile/' + user.username"
                   class="flex items-center gap-3 px-4 py-3 active:bg-blue-100 transition-colors border-b border-blue-50 last:border-0">
            ...
            <div v-if="searchResults.posts.length > 0">
                ...
                <a v-for="post in searchResults.posts" 
                   ...
                   class="block px-4 py-3 active:bg-blue-100 transition-colors border-b border-blue-50 last:border-0">
